...
//   const [loading, setLoading] = useState(false);
//   const [error, setError] = useState<string | null>(null);
//   const [maxResults, setMaxResults] = useState<number>(500); // Default max results
...
//       type: "group",
//       operator: grp.operator,
//       keywords: grp.children.map(transformNode),
//     };
//   };

//   // Formats the payload for the new endpoint
//   const getQueryForEndpoint = () => ({
//     query: {
//       group1: transformNode(rootGroup),
//     },
...
//   // API integration for new endpoint
//   const handleSearch = async () => {
//     setLoading(true);
//     setError(null);
//     setHasSearched(false);
...
//     try {
//       if (!backendPort) throw new Error('Backend port not loaded');
//       const response = await fetch(`http://localhost:${backendPort}/api/search_ops`, {
//         method: 'POST',
//         headers: { 'Content-Type': 'application/json' },
//         body: JSON.stringify(getQueryForEndpoint()),
//       });
...
//           <label htmlFor="max-results" style={{ marginRight: 8, fontWeight: 500 }}>
//             Max Results:
//           </label>
//           <select
//             id="max-results"
