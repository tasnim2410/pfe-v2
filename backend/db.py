...
class RawPatent(db.Model):
    ...
    second_publication_date = db.Column('second_publication_date', db.String(100), nullable=True)
    ...
    first_publication_number = db.Column('first_publication_number', db.String(100), nullable=True)
    second_publication_number = db.Column('second_publication_number', db.String(100), nullable=True)
